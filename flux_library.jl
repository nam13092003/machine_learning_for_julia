...
# ╔═╡ 246b21b0-4953-11f1-9be2-918162cbeebc
using Flux

# ╔═╡ c2daea1d-304f-4aee-8d97-b3c599eb16c8
using Statistics

# ╔═╡ 29b4772a-4393-4929-b1c2-05b15e1d6b09
using Flux: train!

# ╔═╡ 43095032-e1d2-47b2-9b25-95b964f18007
f(x) = 3x+2

# ╔═╡ 44eba9df-5d01-4280-97c0-fbe90a120621
X_train = rand(Float32, 1,6)

# ╔═╡ adc1a924-5dd6-4b9f-8210-8eb2462098f2
y_train = f.(X_train)

# ╔═╡ e95c62e3-4599-42d2-b5b2-d9f24ed4ef9a
model = Dense(1 => 1)

# ╔═╡ 7d24973a-78e2-46b8-9112-e89065f81c6a
model.weight

# ╔═╡ cf9bcefe-4260-4c8c-ba3d-e577e7aba947
model.bias

# ╔═╡ 1414b040-a95b-467f-b0f7-f867ee47ce8e
model(X_train)

# ╔═╡ 02531c07-dda3-4a91-9a5b-b57e0d3bf610
model1 = Chain(
	Dense(1=> 3,relu),
	Dense(3=>1)
)

# ╔═╡ 819f2af6-f99b-4731-8372-5bccf82a85f5
model1(X_train)

# ╔═╡ d9656da6-7221-4927-a046-e62e0f3314cc
loss(model, X_train,y_train) = mean(abs2.(model(X_train)-y_train))

# ╔═╡ e7ce58bb-efa1-4236-8eae-0be45b9bf79a
loss(model, X_train, y_train)

# ╔═╡ 733822dc-6602-4b5c-a3f8-04d857b31793
data = [(X_train,y_train)]

# ╔═╡ 591b200c-dbdf-4f57-91bb-e7c8c5d0574b
opt = Descent(0.1)

# ╔═╡ b4a19fbb-9599-44eb-a9e2-f5f2f4832ad9
for i = 1:2000
	train!(loss,model,data,opt)

end

# ╔═╡ 447a4690-3025-413a-a37c-6125f9202334
model.weight

# ╔═╡ 8a79fe93-70e7-4213-ac50-4eb41d9f314d
model.bias

# ╔═╡ 7022f15e-4363-4600-93d0-48a3c2a1c50d
loss(model, X_train, y_train)

# ╔═╡ 3e6daf7f-4096-4e0d-9208-2f1879d984dd
model([3])
...
manifest_format = "2.0"
project_hash = "94d9c6a26513e67a9d3fe4075cc1ebf1c6b7ccb2"
