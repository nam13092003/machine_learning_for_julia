...
# ╔═╡ 30ee2592-5362-11f1-8273-71aa83acd412
using MLDatasets, DataFrames

# ╔═╡ 0f462484-871b-4a0c-a621-f02520feecf5
using Statistics

# ╔═╡ 29bcadf2-519f-4334-9ded-76ca589ee952
using LinearAlgebra

# ╔═╡ 65429213-607b-4c13-94b6-0458a18f4914
using Plots

# ╔═╡ 36739d2c-2a69-4a97-8757-f6dddeceb7ea
data = Iris()

# ╔═╡ c5898744-573f-4ca5-b531-972900f441c1
X = Matrix(data.features)

# ╔═╡ b16bc661-c415-4cea-89fb-e291f6593be2
y = Matrix(data.targets)

# ╔═╡ 43758756-4c75-4228-8b9c-5e24468496d6
μ = mean(X, dims=1)

# ╔═╡ c5d22846-ef02-4877-ad3e-3ab0840df08d
X̄ = X .-μ

# ╔═╡ f76be6fa-b7b8-4207-8490-3f888af5282f
N =size(X,1)

# ╔═╡ c31efdbe-ef43-4b3b-ba03-c045173eccca
E = X̄'*X/(N-1)

# ╔═╡ 7117bbf2-a5fb-4aae-9343-f4c7498b2d0a
cov(X̄)

# ╔═╡ 9ddef0dd-9144-467c-a6c9-b3cfa3f3b06f
eigen(E)

# ╔═╡ 85e9ee2b-ca6e-438c-90a9-ac21b9ab1630
θ = eigen(E).vectors[:,4:-1:1]

# ╔═╡ 2a85011f-6159-46aa-a49f-6cfa15c10abe
Z =X*θ

# ╔═╡ ff2aa973-2a41-43dc-96f1-a62adb120dce
plot(Z[:,1],Z[:,2],st=:scatter)

# ╔═╡ ac8c20cb-b378-4bfc-a0db-74eb02dd9831


# ╔═╡ 24df73d9-472a-4d90-8092-5adf8c4c4374


# ╔═╡ 2b5e9656-84b4-435f-a9a0-91372a132b93
...
manifest_format = "2.0"
project_hash = "93635227e8346331ca3326cf31ff869370d88d74"
